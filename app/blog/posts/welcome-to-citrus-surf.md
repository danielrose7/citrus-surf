...
- **Spreadsheet to SQL Converter** — Paste from a spreadsheet, get properly escaped SQL VALUES
- **JSON to SQL Converter** — Transform JSON arrays into INSERT or UPDATE statements
- **CSV to JSON / JSON to CSV** — Convert between the two most common data formats
- **Text Slugifier** — Turn titles and text into URL-friendly slugs
- **ID Generator** — Generate batches of UUID v4, UUID v7, or ULIDs
